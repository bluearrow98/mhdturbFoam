...
Also do take note of the fact that while using this solver, even the turbulence model needs to be changed. MHD flows require different turbulence models. There are many literatures available online about them. I use Modified Spalart-Allmaras model :
